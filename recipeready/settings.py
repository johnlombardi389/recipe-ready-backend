"""
Django settings for recipeready project.
...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='john389.pythonanywhere.com').split(',')
...
WSGI_APPLICATION = 'recipeready.wsgi.application'
